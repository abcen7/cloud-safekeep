...
const Dashboard = () => {
  ...
  const items: IItem[] = [
    ...
    },
    {
      title: 'photo1.png',
      tag: 'png',
      preview: 'https://images.unsplash.com/photo-1620120966883-d977b57a96ec?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWFjJTIwb3MlMjB3YWxscGFwZXJ8ZW58MHx8MHx8fDA%3D&w=1000&q=80'
    },
  ]
